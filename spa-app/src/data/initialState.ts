export const appStateData = {
  ...
  quizQuestions: [
    { 
      day: 1, 
      question: 'Сколько ступеней ведет к храму Ват Пра Кео?', 
      answer: 'Нет ступеней', 
      answers: { a: '42', b: '108', c: 'Нет ступеней', d: '365' },
      correctAnswer: 'c'
    },
    { 
      day: 2, 
      question: 'Какое животное считается священным в Таиланде?', 
      answer: 'Слон', 
      answers: { a: 'Тигр', b: 'Слон', c: 'Обезьяна', d: 'Кобра' },
      correctAnswer: 'b'
    },
    { 
      day: 3, 
      question: 'Как называется традиционная тайская лодка на плавучем рынке?', 
      answer: 'Руа', 
      answers: { a: 'Тук-тук', b: 'Руа', c: 'Сонгтео', d: 'Ферри' },
      correctAnswer: 'b'
    },
    { 
      day: 4, 
    ...
    { 
      day: 7, 
      question: 'Как называется тайский традиционный массаж на тайском языке?', 
      answer: 'Нуад', 
      answers: { a: 'Сабай', b: 'Нуад', c: 'Муай', d: 'Том Ям' },
      correctAnswer: 'b'
    },
    { 
      day: 8, 
      question: 'Какое море омывает берега Таиланда с запада?', 
      answer: 'Андаманское', 
      answers: { a: 'Южно-Китайское', b: 'Андаманское', c: 'Филиппинское', d: 'Красное' },
      correctAnswer: 'b'
    },
    { 
      day: 9, 
      question: 'Какой фрукт называют "королем фруктов" в Таиланде?', 
      answer: 'Дуриан', 
      answers: { a: 'Манго', b: 'Дуриан', c: 'Кокос', d: 'Папайя' },
      correctAnswer: 'b'
    },
    { 
      day: 10, 
      question: 'Сколько провинций в Таиланде?', 
      answer: '77', 
      answers: { a: '50', b: '77', c: '100', d: '12' },
      correctAnswer: 'b'
    },
    { 
      day: 11, 
      question: 'Как называется традиционная тайская валюта?', 
      answer: 'Бат', 
      answers: { a: 'Вон', b: 'Донг', c: 'Бат', d: 'Риель' },
      correctAnswer: 'c'
    },
    { 
      day: 12, 
      question: 'Какого цвета такси в Бангкоке?', 
      answer: 'Разноцветные', 
      answers: { a: 'Только желтые', b: 'Только розовые', c: 'Черные', d: 'Разноцветные (розовые, желто-зеленые и др.)' },
      correctAnswer: 'd'
    },
    { 
      day: 13, 
      question: 'Как по-тайски звучит "Спасибо" (для мужчин)?', 
      answer: 'Кхоп кхун кхрап', 
      answers: { a: 'Саватди кхрап', b: 'Кхоп кхун кхрап', c: 'Май пен рай', d: 'Арой мак' },
      correctAnswer: 'b'
    },
    { 
      day: 14, 
      question: 'Сколько островов входит в состав Таиланда?', 
      answer: '1430', 
      answers: { a: 'Около 100', b: 'Ровно 500', c: '1430', d: 'Более 5000' },
      correctAnswer: 'c'
    },
    { 
      day: 15, 
